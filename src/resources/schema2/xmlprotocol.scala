...
trait XMLProtocol extends scalaxb.XMLStandardTypes {
  ...
  trait DefaultRECORDFormat extends scalaxb.ElemNameParser[RECORD] {
    ...
    def parser(node: scala.xml.Node, stack: List[scalaxb.ElemName]): Parser[RECORD] =
      ...
      (scalaxb.ElemName(None, "KAT2")) ~ 
      (scalaxb.ElemName(None, "BIRIM2SATISFIYATI")) ~ 
      (scalaxb.ElemName(None, "BIRIM2BARKODU")) ~ 
      (scalaxb.ElemName(None, "BIRIM3")) ~ 
      (scalaxb.ElemName(None, "KAT3")) ~ 
      (scalaxb.ElemName(None, "BIRIM3SATISFIYATI")) ~ 
      ...
      RECORD(scalaxb.fromXML[Int](p1, scalaxb.ElemName(node) :: stack),
        ...
        scalaxb.fromXML[String](p17, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[String](p18, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[String](p19, scalaxb.ElemName(node) :: stack),
        scalaxb.fromXML[Float](p20, scalaxb.ElemName(node) :: stack)) })
    ...
    def writesChildNodes(__obj: RECORD, __scope: scala.xml.NamespaceBinding): Seq[scala.xml.Node] =
      Seq.concat(scalaxb.toXML[Int](__obj.SUBE_KODU, None, Some("SUBE_KODU"), __scope, false),
        ...
        scalaxb.toXML[String](__obj.KAT2, None, Some("KAT2"), __scope, false),
        ...
        scalaxb.toXML[String](__obj.BIRIM3, None, Some("BIRIM3"), __scope, false),
        scalaxb.toXML[String](__obj.KAT3, None, Some("KAT3"), __scope, false),
        scalaxb.toXML[String](__obj.BIRIM3SATISFIYATI, None, Some("BIRIM3SATISFIYATI"), __scope, false),
